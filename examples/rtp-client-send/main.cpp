...
int main(int argc, char **argv) try {
	...
	while (true) {
		...
		if (auto localAddress = pc->localAddress(); localAddress)
			std::cout << "local address: " << &localAddress << std::endl;
		else
			std::cout << "localAddress is null\n";
		if (auto remoteAddress = pc->remoteAddress(); remoteAddress)
			std::cout << "remote address: " << &remoteAddress << std::endl;
		else
			std::cout << "remote Address is null\n";
